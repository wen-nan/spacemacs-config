...
before packages are loaded."
  ...
  ;; org todos files path
  (setq org-agenda-files (list "~/orgFiles/todos.org"))
  ;; org mode indent display
  (setq org-startup-indented t)
  ;; python indent offset can't guess
